//==================================================================GTOM_fnc_IedDeadlyExplosion============================================================================
// Create a deadly explosion, explosion dimiter will be decided by the _trapvolume
// Example: [_pos,_trapvolume] spawn GTOM_fnc_IedDeadlyExplosion;
...

{
	...
	[_x,_relVel,(_relVel/10),_pos,false] remoteExec ["GTOM_fnc_addVelocity",_x];
} forEach _effected;