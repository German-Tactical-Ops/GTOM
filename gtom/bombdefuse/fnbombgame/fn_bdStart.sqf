...
_disarmTime = (_realIED getvariable ["GTOM_disarmTime",0]) max 120;
...
if !([_difficulty,_modules,_disarmTime] call GTOM_fnc_initBombDefuse) then {
  ...
  _realIED setVariable ["GTOM_isInteracted",false,true];
};