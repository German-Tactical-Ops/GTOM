/*=================================================================GTOM_fnc_initDynamicDialog==================================================================================
  ...
  Parameter(s):
     ...
     Example ["My dialog",[["question1",["Option1","option2"]],["question2",["Option1","option2"]],["question3",["Option1","option2"]]],"GTOM_fnc_artillery"] call GTOM_fnc_initDynamicDialog
*/
...
_ok = createDialog "GTOM_DynamicDialog";
waitUntil {dialog};
...
missionNamespace setVariable ["GTOM_DynamicDialogOK",false];
_ctrlButtonOK ctrlSetEventHandler ["ButtonClick", "missionNamespace setVariable ['GTOM_DynamicDialogOK', true];"];
...
waitUntil {(missionNamespace getVariable ["GTOM_DynamicDialogOK",false]) || (tolower str (findDisplay 1031982) == "no display")};
...
//if cancel exit
if !(missionNamespace getVariable ["GTOM_DynamicDialogOK",false]) exitWith {_resaults};
