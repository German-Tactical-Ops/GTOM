/*=============================================================GTOM_fnc_addVelocity=========================================================================================
	adds velocity to object depends on its current velocity and with relation to center - create a shockwave
	 <IN>
		...
		EXAMPLE:
		[player,10,10] call GTOM_fnc_addVelocity
...
if (isNull _object) exitWith {diag_log "GTOM Error: GTOM_fnc_addVelocity - invalid object"};
if (!local _object) exitWith  {diag_log "GTOM Error: GTOM_fnc_addVelocity - Object isn't local"};
