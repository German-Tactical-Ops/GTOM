...
private _nvg_main = ["A3_GPNVG18_F"];

// --------------------------------------------------

private _binoculars_main = ["Binocular"];

private _binoculars_medium = ["Binocular","Rangefinder"];

private _binoculars_sniper = ["Rangefinder","ACE_VectorDay","ACE_Vector"];

private _binoculars_sl = ["Rangefinder","ACE_VectorDay","ACE_Vector"];
...
_items append (switch (_role) do
{
    ...
    case "zeus":{
        ...
        _binoculars_main+
        _mapCompasRadio+
        ["rhs_weap_SCARH_USA_CQC","GTO_Beret_White","GTO_BaseUniform","VSM_MBSS_PACA_WTF","VSM_MBSS_WTF","TFAR_mr6000l","TFAR_anprc152","H_Construction_headset_white_F","H_Construction_earprot_white_F","H_Construction_basic_white_F","H_Construction_headset_vrana_F","H_Construction_earprot_vrana_F","H_Construction_basic_vrana_F"]
    };
